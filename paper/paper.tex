...
Proof of work is a very costly and energy ineficient means to reaching
...
is rather complex; a large part of the effort for this project was in
understanding the nuances of how it works. Here we'll give a
best-effort summary on how it works, but for more understanding the
full paper\cite{stellar} is neccesary. For simplicity, we will talk
